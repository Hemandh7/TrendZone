...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('https://63c6d562d307b76967421abd.mockapi.io/products');
  ...
  const handleProductCreate = async (event) => {
    ...
    try {
      const response = await axios.post('https://63c6d562d307b76967421abd.mockapi.io/products', productFormData);
  ...
  const handleProductUpdate = async (event) => {
    event.preventDefault();
    try {
      const response = await axios.put(`https://63c6d562d307b76967421abd.mockapi.io/products/${editingProductId}`, editingProductData);
  ...
  const handleProductDelete = async (id) => {
    try {
      await axios.delete(`https://63c6d562d307b76967421abd.mockapi.io/products/${id}`);
