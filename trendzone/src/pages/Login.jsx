...
function LoginSignup() {
  ...
  async function handleLogin() {
    try {
      const response = await fetch(`https://63c6d562d307b76967421abd.mockapi.io/Login?email=${email}&password=${password}`);
  ...
  async function handleSignup() {
    ...
    try {
      const response = await fetch("https://63c6d562d307b76967421abd.mockapi.io/Login", {
        method: "POST",
        headers: {
